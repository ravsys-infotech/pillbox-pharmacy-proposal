...
const MODULES = [
  ...
  },
  {
    ...
    features: ["Dual-Phase Rollout", "Commerce-First Sequencing", "Milestone-Gated Delivery", "SEO & Discovery Centric"],
  ...
  },
  {
    ...
    features: ["16 Core Modules", "Independently Deployable", "No Plugin Dependencies", "Commerce-to-Infrastructure Coverage"],
  ...
  },
  {
    ...
    features: ["Mobile-First UX", "Sub-3s Load on 4G", "PDP with Recommendations", "Frictionless Cart"],
